   ...
   <div>
      ...
      <div v-click-outside="config" class="right-bar">
         <div data-simplebar class="h-100">
            ...
            <div class="p-4">
               <div class="mb-2">
                  <router-link to="//http://iWebDesigner.vuejs-light-h.themesdesign.in/" target="_blank">
                     <img src="@/assets/images/layouts/layout-4.jpg" class="img-fluid img-thumbnail" alt />
                  </router-link>
               </div>

               <div class="mb-2">
                  <router-link to="//http://iWebDesigner.vuejs-dark-h.themesdesign.in/" target="_blank">
                     <img src="@/assets/images/layouts/layout-5.jpg" class="img-fluid img-thumbnail" alt />
                  </router-link>
               </div>

               <div class="mb-2">
                  <router-link to="//http://iWebDesigner.vuejs-rtl-h.themesdesign.in/" target="_blank">
