          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a
                ...
                @click="onMenuClick"
              >
                <i class="ri-layout-3-line mr-2"></i
              ...
              >
                <a @click="change_layout('vertical')" class="dropdown-item">{{
                  $t("menuitems.layouts.list.vertical")
                }}</a>
                <a @click="topbarLight()" class="dropdown-item">{{
                  $t("menuitems.layouts.list.lighttopbar")
                }}</a>
                <a @click="boxedWidth()" class="dropdown-item">{{
                  $t("menuitems.layouts.list.boxed")
                }}</a>
              </div>
            </li>
          </ul>
